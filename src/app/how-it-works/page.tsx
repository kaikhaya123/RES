            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
              {[
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 p-8 md:p-10 rounded-xl hover:border-honey-tan/50 transition-all duration-300"
                >
                  <p className="text-honey-tan text-4xl font-black mb-5">{item.phase}</p>
                  <h3 className="text-2xl md:text-3xl font-black mb-8 leading-tight">{item.title}</h3>
                  <ul className="space-y-4">
                    {item.points.map((point, i) => (
                      <li key={i} className="flex gap-4 items-start">
                        <CheckCircle className="w-6 h-6 text-honey-tan flex-shrink-0 mt-0.5" />
              ...
              >
                ...
                <ul className="space-y-5">
                  {[
                    ...
                    <li key={i} className="flex gap-4 items-start">
                      <div className="w-2.5 h-2.5 bg-honey-tan rounded-full mt-2 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white/5 border border-white/10 p-8 rounded-xl text-center hover:border-honey-tan/50 transition-all duration-300"
                >
                  <p className="text-xs text-white/60 mb-3 uppercase tracking-widest font-black">{item.stage}</p>
                  <p className="text-4xl font-black text-honey-tan mb-4">{item.evicted}</p>
