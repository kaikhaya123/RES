      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-12 max-w-7xl relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 lg:gap-20 items-stretch mb-12 md:mb-16 lg:mb-20">
          ...
          >
            ...
            >
              <Link
                href="/auth/register"
                className="group inline-flex items-center gap-3 px-8 py-4 bg-brand-yellow text-black font-black text-sm uppercase tracking-[0.15em] hover:bg-yellow-600 transition-all duration-300"
              >
        ...
        >
          ...
          >
            <Link
              href="/auth/register"
              className="group inline-flex items-center gap-3 px-10 py-5 bg-brand-yellow text-black font-black text-sm uppercase tracking-[0.15em] hover:bg-yellow-600 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            >
              <span>Register Now</span>
